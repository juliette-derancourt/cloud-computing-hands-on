...
public class RegisterTest {
    ...
    public void sequential() {
        ...
        Register<Integer> copy1 = manager.newRegister(name, true);
        Register<Integer> copy2 = manager.newRegister(name);
        Register<Integer> copy3 = manager.newRegister(name);
